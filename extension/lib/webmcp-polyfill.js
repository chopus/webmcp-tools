/**
 * Vendored from https://github.com/GoogleChromeLabs/webmcp-tools
 * Source file: demos/shared/webmcp-polyfill.js
 * Source commit: 41cb97a29002a2f2d3fb3ab05bde92652118c667
 * Vendored for WebMCP Tools — injected into pages in the MAIN world via
 * chrome.scripting.executeScript({ world: "MAIN", files: [...] }) when
 * `list_webmcp_tools` is called with injectPolyfill: true.
 *
 * The file below is unmodified from the source (it is already idempotent:
 * it no-ops when document.modelContext already exists, and it defines
 * window.__webmcp_registered_tools plus document.modelContext with
 * registerTool/getTools/executeTool and declarative form[toolname] support).
 */
/**
